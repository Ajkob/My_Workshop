...
const char* ssid     = "dragons"; //Use own ssid
const char* password = "dragonsoffice"; //use password of AP
...
void setup() {
    Serial.begin(115200);
    delay(10);
    pinMode(PUMP_RLY, OUTPUT); // Initialize the PUMP_RLY pin as an output
...
void uploadThingsSpeak(float t, float h) {
    ...
    static const char* apiKey = "5S6JQXI7GINCIBMU"; //Change to your API Key
